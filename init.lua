...
_Conf = {
	...
	byPassModulesIsOn = optionIsOn(Config.byPassModules.state),
	...
	byPassUrlProtect = parseRuleFile(Config.byPassModules.urlProtect),
	...
	byDenyIpList = parseRuleFile(Config.byDenyIpModules.ipList),
...
--判断hgModules是否开启
if _Conf.hgModulesIsOn then
	_Conf.dict_captcha:set("hgOn",1)
else
	_Conf.dict_captcha:set("hgOn",0)
end
...
--判断byPassModules是否开启
if _Conf.byPassModulesIsOn then
	_Conf.dict_captcha:set("byPassOn",1)
else
	_Conf.dict_captcha:set("byPassOn",0)
end
